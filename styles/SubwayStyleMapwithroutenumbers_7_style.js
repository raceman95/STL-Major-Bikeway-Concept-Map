...
var style_SubwayStyleMapwithroutenumbers_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (feature.get("Label") !== null) {
        ...
        function rules_SubwayStyleMapwithroutenumbers_7(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_SubwayStyleMapwithroutenumbers_7rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule2_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule3_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule4_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule5_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule6_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule7_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule8_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule9_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule10_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule11_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule12_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_SubwayStyleMapwithroutenumbers_7rule13_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        var style = rules_SubwayStyleMapwithroutenumbers_7(feature, value);
        ;
